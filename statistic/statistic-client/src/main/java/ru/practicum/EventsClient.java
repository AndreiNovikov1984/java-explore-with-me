...
public class EventsClient extends Client {
    ...
    public ResponseEntity<Object> postStatistic(StatisticDtoIncom statisticDtoIncom) {
        log.info("Get post statistic {}", statisticDtoIncom);
        return post("", statisticDtoIncom);
    }
}